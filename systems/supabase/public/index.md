...
17 objects · 0 with human docs.

| Object | Kind | Machine doc | Human doc | Status |
|---|---|---|---|---|
...
| `jobs` | table | [jobs.schema.md](jobs.schema.md) | — | — |
| `master_cvs` | table | [master_cvs.schema.md](master_cvs.schema.md) | — | — |
| `subscriptions` | table | [subscriptions.schema.md](subscriptions.schema.md) | — | — |
| `tailored_cvs` | table | [tailored_cvs.schema.md](tailored_cvs.schema.md) | — | — |
